...
public class Article implements Comparable<Article> {
    protected @NotNull
    final List<Article> innerArticles;
    protected @NotNull
    ...
    public Article(List<AbstractContent> content, List<Article> subArticles, @NotNull String directoryName,
            @NotNull LocalDateTime created, @NotNull LocalDateTime lastUpdate) {
        this.content = content;
        this.lastUpdate = lastUpdate;
        this.created = created;
        if (subArticles == null){
            this.innerArticles = null;
        }else{
...
//            last = innerCreatedEvent.get();
    ...
    public Article getParent() { return this.parent;}

    public void setParent(Article parent) { this.parent = parent;}
}
